...
class UpdatePage extends StatefulWidget {
  ...
  const UpdatePage({super.key,required this.products ,required this.index});
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(  
                        hintText: "${widget.products[widget.index].name}",                      
                  ...
                  SizedBox(
                    ...
                    child: TextField(
                      decoration: InputDecoration(
                        hintText: "${widget.products[widget.index].catagory}",
                        fillColor: Colors.grey[200],
                        filled: true,
                        contentPadding: const EdgeInsets.symmetric(vertical: 15, horizontal: 15),
                        enabledBorder: OutlineInputBorder(
                  ...
                  SizedBox(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: "${widget.products[widget.index].price}",
                        fillColor: Colors.grey[200],
                        filled: true,
                        contentPadding: const EdgeInsets.symmetric(vertical: 15, horizontal: 15),
                        enabledBorder: OutlineInputBorder(
