...
class _DetailPageState extends State<DetailPage> {
                                    ...
                                    child: ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        return Padding(
                                          ...
                                          child: listedButtons(sizelist[index]),
                                        );
                                      },
                                    ),
                                  ),
  ...
  Widget listedButtons(String size) {
    ...
    return Container(
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          foregroundColor: isSelected ? Colors.white : Colors.black, backgroundColor: isSelected ? Colors.blue : Colors.grey[200], minimumSize: Size(60, 60), 
          shape: RoundedRectangleBorder(
